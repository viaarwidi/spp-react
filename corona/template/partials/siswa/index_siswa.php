      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="navbar p-0 fixed-top d-flex flex-row">
          <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
            <a class="navbar-brand brand-logo-mini" href="index_siswa.php"><img src="../../assets/images/logo-mini.svg" alt="logo" /></a>
          </div>
            ...
            <div class="row">
                <div class="card">
                  <div class="card-body p-lg-12">
									...
									<p class="lead">Anda login menggunakan akun siswa.</p>
									<hr class="my-3">
									<p>Ini adalah halaman dashboard petugas yang digunakan untuk sistem pembayaran SPP sekolah.</p>
									<a class="btn btn-primary btn-lg" href="index_siswa.php" role="button">Learn more</a>
									</div>
              </div>
              </div>
            </div>  
