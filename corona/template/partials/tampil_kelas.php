    ...
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Tampil Kelas</h4>
                  <p class="card-description"> Lihat daftar siswa disini <code></code>
                  <div class="table-responsive">
                    <table class="table table-striped">
                      <thead>
                      <tr>
                      <th>NO</th><th>Id Kelas</th><th>Nama Kelas</th><th>Kompetensi Keahlian</th><th>Aksi</th>
                        </tr>
                      </thead>
                      <tbody>
                      <?php
                    ...
                    <td><a href="tambah_kelas.php" class="btn btn-success">Tambah Kelas</a></td>
                  </div>
                </div>
              </div>
            </div>
