              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">
                    Cari Kelas Siswa yang Melakukan Pembayaran.
                  </p>
                  <div class="table-responsive">
                      ...
                      <tbody>
                        ...
                        while($data_kelas=mysqli_fetch_array($qry_kelas)){
                            ...
                            <tr>
                                ...
                                <td><a href="transaksi_siswa.php?id_kelas=<?=$data_kelas['id_kelas']?>" class="badge badge-primary">Lihat</a></td>
                            </tr>
                            <?php } ?>
                            <?php
                            ?>
                    ...
                    <br><td><a href="tambah_kelas.php" class="btn btn-outline-primary">Tambah Kelas</a>
                  </div>
                </div>
              </div>
            </div>
