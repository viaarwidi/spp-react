              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">
                    Cari Nama Siswa yang Melakukan Pembayaran.
                  </p>
                  <div class="table-responsive">
                    ...
                    <br><td><a href="tambah_siswa.php" class="btn btn-outline-primary">Tambah Siswa</a>
                    <td><a href="transaksi_kelas.php" class="btn btn-light">Cancel</a>
                  </div>
                </div>
              </div>
            </div>
