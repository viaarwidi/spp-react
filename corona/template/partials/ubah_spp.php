                  ...
                  <div class="card-body">
                        <form class="forms-sample">
                          <div class="form-group">
                            <input type="hidden" name="id_spp" class="form-control" value="<?= $dt_spp['id_spp']; ?>">
                          </div>
                          <div class="form-group">
                            <label>Tahun</label>
                            <input type="text" name="tahun" class="form-control" value="<?= $dt_spp['tahun']; ?>">
                          </div>
                         <div class="form-group">
                            <label>Nominal</label>
                            <input type="text" name="nominal" class="form-control" value="<?= $dt_spp['nominal']; ?>">
                          </div>
                          
                          <button type="submit" class="btn btn-primary">Submit</button>
                          <a href="tampil_spp.php" class="btn btn-light">Cancel</button>
                        </form>
