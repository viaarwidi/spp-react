        ...
        <!-- partial -->
          ...
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Ubah Petugas </h3>
                  ...
                  <div class="card-body">
                        <form class="forms-sample">
                          ...
                          <div class="form-group">
                            ...
                            <input type="password" name="password" class="form-control" value="<?= $dt_petugas['password']; ?>">
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            <label>Level</label>
                            <select name="level" class="form-control" value="<?= $dt_petugas['level']; ?>">
