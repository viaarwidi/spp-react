                  ...
                  <div class="card-body">
                        <form class="forms-sample">
                          <div class="form-group">
                            <input type="hidden" name="id_kelas"  class="form-control" value="<?= $dt_kelas['id_kelas']; ?>">
                            </div>
                          <div class="form-group">
                            <label>Nama Kelas</label>
                            <input type="text" name="nama_kelas" class="form-control" value="<?= $dt_kelas['nama_kelas']; ?>">
                          </div>
                          <div class="form-group">
                            <label>Kompetensi Keahlian</label>
                            <input type="text" name="kompetensi_keahlian" class="form-control" value="<?= $dt_kelas['kompetensi_keahlian']; ?>">
                          </div>
